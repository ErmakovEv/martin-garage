      ...
      >
        ...
        >
          ...
          >
            ...
            . Мы выполняем ремонт автомобилей любой сложности, а также делаем
            полное техническое обслуживание. Можем проконсультировать по работам
            и подбору автозапчастей.{' '}
            <span
              style={{
                fontSize: '1.8vh',
                color: '#c5dea1',
